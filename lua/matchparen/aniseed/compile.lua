...
local _2amodule_name_2a = "matchparen.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("matchparen.aniseed.core"), autoload("matchparen.aniseed.fennel"), autoload("matchparen.aniseed.fs"), autoload("matchparen.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "matchparen.aniseed.macros"
  local filename
  do
