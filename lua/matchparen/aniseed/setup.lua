...
local _2amodule_name_2a = "matchparen.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("matchparen.aniseed.core"), autoload("matchparen.aniseed.env"), autoload("matchparen.aniseed.eval"), autoload("matchparen.aniseed.nvim")
