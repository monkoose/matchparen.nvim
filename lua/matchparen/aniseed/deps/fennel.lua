package.preload["matchparen.aniseed.fennel.repl"] = package.preload["matchparen.aniseed.fennel.repl"] or function(...)
  local utils = require("matchparen.aniseed.fennel.utils")
  local parser = require("matchparen.aniseed.fennel.parser")
  local compiler = require("matchparen.aniseed.fennel.compiler")
  local specials = require("matchparen.aniseed.fennel.specials")
  local view = require("matchparen.aniseed.fennel.view")
...
package.preload["matchparen.aniseed.fennel.specials"] = package.preload["matchparen.aniseed.fennel.specials"] or function(...)
  local utils = require("matchparen.aniseed.fennel.utils")
  local view = require("matchparen.aniseed.fennel.view")
  local parser = require("matchparen.aniseed.fennel.parser")
  local compiler = require("matchparen.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "matchparen.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["matchparen.aniseed.fennel.compiler"] = package.preload["matchparen.aniseed.fennel.compiler"] or function(...)
  local utils = require("matchparen.aniseed.fennel.utils")
  local parser = require("matchparen.aniseed.fennel.parser")
  local friend = require("matchparen.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["matchparen.aniseed.fennel.friend"] = package.preload["matchparen.aniseed.fennel.friend"] or function(...)
  local utils = require("matchparen.aniseed.fennel.utils")
...
package.preload["matchparen.aniseed.fennel.parser"] = package.preload["matchparen.aniseed.fennel.parser"] or function(...)
  local utils = require("matchparen.aniseed.fennel.utils")
  local friend = require("matchparen.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["matchparen.aniseed.fennel.view"] = package.preload["matchparen.aniseed.fennel.view"] or function(...)
...
package.preload["matchparen.aniseed.fennel.utils"] = package.preload["matchparen.aniseed.fennel.utils"] or function(...)
  local view = require("matchparen.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("matchparen.aniseed.fennel.utils")
local parser = require("matchparen.aniseed.fennel.parser")
local compiler = require("matchparen.aniseed.fennel.compiler")
local specials = require("matchparen.aniseed.fennel.specials")
local repl = require("matchparen.aniseed.fennel.repl")
local view = require("matchparen.aniseed.fennel.view")
...
do
  ...
  local module_name = "matchparen.aniseed.fennel.macros"
  local _
