...
local _2amodule_name_2a = "matchparen.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("matchparen.aniseed.compile"), autoload("matchparen.aniseed.fennel"), autoload("matchparen.aniseed.fs"), autoload("matchparen.aniseed.nvim")
