...
local _2amodule_name_2a = "matchparen.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("matchparen.aniseed.core"), autoload("matchparen.aniseed.fs"), autoload("matchparen.aniseed.nvim"), autoload("matchparen.aniseed.string")
...
local function impl()
  local compiler = require("matchparen.aniseed.deps.fennel")
