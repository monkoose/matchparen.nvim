...
local _2amodule_name_2a = "matchparen.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("matchparen.aniseed.core"), autoload("matchparen.aniseed.compile"), autoload("matchparen.aniseed.fennel"), autoload("matchparen.aniseed.fs"), autoload("matchparen.aniseed.nvim")
